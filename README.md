...
IOCC is a dependency injection framework written in Rust, where IOCC stands for "IOC Container". IOCC is inspired by [Spring Framework](https://spring.io/projects/spring-framework) and [Google Guice](https://github.com/google/guice), along with Rusty features.
